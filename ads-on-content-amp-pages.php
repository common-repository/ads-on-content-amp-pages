...
function aacap_ads_function(){
    ...
    $shar7 = '<span style="cursor:pointer;" title="The Number of Line to Show The ads after">?</span>';
    ...
    add_settings_field("aads_slot_content", "Number of Line ".$shar7, "aacap_aadcontent_num", "aads-options", "section");
...
?>
    <div class="wrap">
        ...
        <br /><br />
        <div style="text-align:center;font-size:2em;background-color:#fff;width:60%;padding:21px;margin:7px;box-shadow:0 1px 1px 0 #c1c1c1;border-left:7px solid green">
          support us to do more -> 
          <a style="font-weight:bold;" href="https://www.paypal.me/AlaaAbdelsamie" target="_blank">Support</a> || 
          <a style="font-weight:bold;" href="https://wordpress.org/plugins/ads-on-content-amp-pages/#reviews" target="_blank">Rating</a>
        </div>
    </div>
<?php
}
